    ...
    <div className="overflow-x-auto rounded-xl border border-gray-200 bg-white scrollbar-thin">
      <div style={{ minWidth: LEFT_COL_WIDTH + totalWidth }}>
        ...
        <div className="flex border-b border-gray-200 bg-gray-50">
          <div
            className="shrink-0 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-gray-500"
            ...
            <div className="flex h-full">
              {months.map((m) => {
                ...
                return (
                  <div
                    key={m.toISOString()}
                    className="border-l border-gray-200 px-2 py-2 text-xs font-medium text-gray-500"
...
function GanttRow({
  ...
  return (
    <div className="flex items-center border-b border-gray-100 hover:bg-gray-50/60">
      {/* Left label */}
      <div
      ...
      >
        ...
        <button
          ...
          className="min-w-0 flex-1 truncate text-left text-sm text-gray-700 hover:text-brand-700"
          title={issue.title}
        >
...
function Unscheduled({
  ...
  return (
    <section className="rounded-xl border border-gray-200 bg-white p-5">
      <h2 className="mb-1 text-sm font-semibold text-gray-900">Unscheduled</h2>
